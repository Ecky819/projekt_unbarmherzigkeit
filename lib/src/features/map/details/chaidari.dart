...
import '../../auth/auth_guard.dart'; // KORREKTER IMPORT
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                ...
                'Chaidari wurde zum Symbol für Repression, Leid und den Widerstand gegen die nationalsozialistische Besatzung.',
                style: TextStyle(fontSize: 16),
              ...
              const Text(
                ...
                'Das Lager bestand aus mehreren Blöcken, darunter der berüchtigte Block 15, der für Einzelhaft und Folterungen genutzt wurde. '
                'Die durchschnittliche Zahl der Inhaftierten lag zwischen 2.000 und 3.000 Personen, insgesamt wurden etwa 20.000 bis 25.000 Menschen dort festgehalten.',
                style: TextStyle(fontSize: 16),
                textAlign: TextAlign.left,
              ),
              const SizedBox(height: 16),
              ...
              const Text(
                ...
                'Am 25. Mai 1944 verließen 850 Männer und 61 Frauen das Lager in Richtung der Konzentrationslager Neuengamme und Ravensbrück. '
                'Ein besonders tragisches Ereignis war die Exekution von 200 politischen Gefangenen am 1. Mai 1944 am Schießstand von Kesariani als Vergeltungsmaßnahme für ein Attentat auf einen deutschen General.',
                style: TextStyle(fontSize: 16),
                textAlign: TextAlign.left,
              ),
              const SizedBox(height: 16),
              ...
              const SizedBox(height: 8),
              const Text(
                'Unter den Inhaftierten befanden sich zahlreiche prominente Persönlichkeiten, darunter: '
                'Lela Karagianni: Widerstandskämpferin und Gründerin der Untergrundorganisation „Bouboulina", wurde am 8. September 1944 hingerichtet. '
                'Marcel Nadjari: Griechischer Jude, der nach Auschwitz deportiert wurde und dort dem Sonderkommando angehörte. '
                'Rena Dor: Schauspielerin, die in Block 15 inhaftiert war. '
                'Nikos Skalkottas: Komponist, der ebenfalls zu den Gefangenen zählte.',
                style: TextStyle(fontSize: 16),
                textAlign: TextAlign.left,
              ),
              const SizedBox(height: 16),
              ...
              const Text(
                ...
                'essenziell für das historische Bewusstsein und die Mahnung an zukünftige Generationen.',
                style: TextStyle(fontSize: 16),
                textAlign: TextAlign.left,
              ),
              const SizedBox(height: 16),
              ...
              const SizedBox(height: 8),
              const Text(
                'Wikipedia: Konzentrationslager Chaidari\n'
                'Gedenkorte Europa: KZ Chaidari\n'
                'Erinnerungen an die Okkupation in Griechenland: Konzentrationslager Chaidari\n'
                'Wikipedia: Lela Karagianni\n'
                'Wikipedia: Marcel Nadjari\n'
                'Spiegel Online: Griechenland unter deutscher Besatzung – Spurensuche',
