...
class Detail16Februar1943 extends StatefulWidget {
  const Detail16Februar1943({super.key});

  @override
  State<Detail16Februar1943> createState() => _Detail16FebruarState();
}

class _Detail16FebruarState extends State<Detail16Februar1943> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('16-17. Februar 1943'),
